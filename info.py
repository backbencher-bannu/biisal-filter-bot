...
BOT_TOKEN = environ.get('BOT_TOKEN', '7504446129:AAE9ExIxyftKqIK6ZlBpXwG_8dc0AOdy_Tg')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1989461858 ').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/benclass10")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002226636138').split()]
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002290275432'))
...
URL = environ.get('URL', 'movies24.koyeb.app/')
STICKERS_IDS = ('CAACAgUAAxkBAAIBg2bEt_h3FMrkOWUKu4aP2Lhnf9j_AAJ8FwACZlKZVCflAAGTXRopJR4E').split()
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1002593931448')
...
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002290275432'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002236393475'))
